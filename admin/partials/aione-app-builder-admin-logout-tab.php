			...
			<table class='form-table'>
				<tbody>
					...
					<tr>
						...
						<td><?php wp_dropdown_pages(array('name' => 'logout_redirect_page','show_option_none' => 'Select Logout Redirect Page','id' => 'logout_redirect_page','selected'=> get_option('logout_redirect_page'))); ?>
							<p class="description">Select the page users will be redirected to after logout.</p>
						</td>
					</tr>
				</tbody>
			</table>
