			...
			<table class='form-table'>
				<tbody>
					...
					<tr>
						...
						<td><?php wp_dropdown_pages(array('name' => 'aione_app_builder_forgot_password_page','show_option_none' => 'Select Forgot Password Page','id' => 'aione_app_builder_forgot_password_page','selected'=> get_option('aione_app_builder_forgot_password_page'))); ?></td>
					</tr>
