...
class Aione_App_Builder_Admin_Aione_Custom_Post_Type {
	...
	function aione_admin_menu_summary_cpt()
	{
	    ...
	    ?>
	    <div id="aione_add_cpt" class="hidden">
	    	<?php echo  $this->aione_edit_cpt();?>
	    </div></div>
	    <?php
	...
	function aione_edit_cpt(){
		...
		if(isset($_POST['cpt_noncesave']) && isset($_POST['cpt_name_plural']) && isset($_POST['cpt_name_singular']) && isset($_POST['cpt_slug']) && isset($_POST['action']) && $_POST['action']== 'aione_cpty'){
		...
		<input type="hidden" name="action" value="aione-cpt" />
		<div id="poststuff">
            	...
            	<div id="submitdiv" class="postbox ">
					...
					<div class="inside">
 						...
 						<?php if (isset($_GET['aione-post-type']) && !empty($_GET['aione-post-type'])){
 							echo '<input type="submit" id="aione-cpt-submit" name="wpcf-submit" value="Update Post Type" class="button-primary wpcf-disabled-on-submit wpcf-form-submit form-submit submit">';
 						} else {
 							echo '<input type="button" id="aione-cpt-submit" name="wpcf-submit" value="Save Post Type" class="button-primary wpcf-disabled-on-submit wpcf-form-submit form-submit submit">';
 						}
 						?>
