(function( $ ) {
	 ...
	 */
	 $( document ).ready(function(){
	     ...
	     * Auto Generated Slug
	     */
	    $( document ).on( 'blur focus click', '.js-wpcf-slugize', function() { 
        ...
        $( 'input[name="aione_cpt_rewrite_custom"]' ).change( function() {
            if( jQuery( this ).val() == 'custom' ) {
                jQuery( '#aione-types-form-rewrite-custom-toggle' ).slideDown();
            } else {
                jQuery( '#aione-types-form-rewrite-custom-toggle' ).slideUp();
            }
        } );
        $( '.wpcf-tax-form input[name="aione_cpt_rewrite_enabled"]' ).change( function() {
            if( jQuery( this ).is( ':checked' ) ) {
                jQuery( '#aione-types-form-rewrite-toggle' ).slideDown();
            } else {
                jQuery( '#aione-types-form-rewrite-toggle' ).slideUp();
            }
        } );
        $( 'input[name="aione_cpt_show_in_menu"]' ).change( function() {
            if( jQuery( this ).is( ':checked' ) ) {
                jQuery( '#aione_cpt_show_in_menu_page' ).slideDown();
            } else {
                jQuery( '#aione_cpt_show_in_menu_page' ).slideUp();
            }
        } );
        $( 'input[name="aione_cpt_has_archive"]' ).change( function() {
            if( jQuery( this ).is( ':checked' ) ) {
                jQuery( '#aione_cpt_has_archive_slug' ).slideDown();
            } else {
                jQuery( '#aione_cpt_has_archive_slug' ).slideUp();
            }
        } );
        $( 'input[name="aione_cpt_query_var_enabled"]' ).change( function() {
            if( jQuery( this ).is( ':checked' ) ) {
                jQuery( '#aione_cpt_query_var' ).slideDown();
            } else {
                jQuery( '#aione_cpt_query_var' ).slideUp();
            }
        } );
