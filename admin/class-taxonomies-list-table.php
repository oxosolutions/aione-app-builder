 ...
 *
 */
class Aione_App_Builder_Admin_Taxonomies_List_Table extends WP_List_Table{

    var $custom_taxonomies;
    var $builtin_taxonomies;
    var $bulk_action_field_name = 'aione_taxonomy_ids';
    ...
    function __construct()    {
        ...
        $this->custom_taxonomies = get_option(AIONE_OPTION_NAME_TAXONOMIES, array());
        $this->builtin_taxonomies = aione_get_builtin_in_taxonomies();
    }
            ...
            $a = array(
                ...
                'delete'     => sprintf(
                    ...
                    esc_url(
                        add_query_arg(
                            array(
                                'action' => 'aione_ajax_delete_taxonomy',
                                'aione_action' => 'delete_taxonomy',
                                'aione-taxonomy-slug' => $item['slug'],
    ...
    function get_columns()
    {
        $columns = array(
            ...
            'supports'  => __('PostTypes/Components', 'aione-app-builder'),
        );
        return $columns;
    }
    /** ************************************************************************
    ...
    function process_bulk_action()
    {
        ...
        if (
             ...
             * update components
             */
            update_option(AIONE_OPTION_NAME_TAXONOMIES, $this->custom_taxonomies);
            /**
             * update post types
             */
    ...
    function prepare_items()
    {
         ...
         */
        $per_page = $this->get_items_per_page('aione_taxonomy_per_page', 20);;
        ...
        if ( !empty($this->custom_taxonomies) ){
            ...
            foreach( $this->custom_taxonomies as $slug => $taxonomy ) {
                ...
                $one = array(
                    ...
                    AIONE_AUTHOR => isset($taxonomy[AIONE_AUTHOR])? $taxonomy[AIONE_AUTHOR]:0,
                    'type' => 'custom',
                    '_builtin' => false,
                );
                $add_one = true;
        ...
        foreach( $this->builtin_taxonomies as $taxonomy ) {
            ...
            $one = array(
                'description' => __('This is built-in WordPress Taxonomy.', 'aione-app-builder'),
        ...
        foreach(array('category', 'post_tag') as $slug ) {
            if ( isset($data[$slug]) ) {
                ...
                $data[$slug]['description'] = __('This is built-in WordPress Taxonomy.', 'aione-app-builder');
            }
        }
    ...
    {
        if ( isset($_POST['s']) ) {
            _e('No custom taxonomies found.','aione-app-builder');
            return;
        }
        printf(
