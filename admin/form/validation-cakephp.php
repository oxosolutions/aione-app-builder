...
if (!class_exists('Aione_Cake_Validation')) {

    class Aione_Cake_Validation {
        ...
        function &getInstance() {
            ...
            if (!$instance) {
                $instance[0] = new Aione_Cake_Validation();
            }
            return $instance[0];
        }
        ...
        function notEmpty($check) {
            $_this = & Aione_Cake_Validation::getInstance();
            $_this->__reset();
            $_this->check = $check;
        ...
        function comparison($check1, $operator = null, $check2 = null) {
            ...
            switch ($operator) {
                ...
                default:
                    $_this = & Aione_Cake_Validation::getInstance();
                    $_this->errors[] = __('You must define the $operator parameter for Aione_Cake_Validation::comparison()', 'aione-app-builder');
                    break;
            }
            return false;
        }
        ...
        function custom($check, $regex = null) {
            ...
            if ($_this->regex === null) {
                $_this->errors[] = __('You must define a regular expression for Aione_Cake_Validation::custom()', 'aione-app-builder');
                return false;
            }
            return $_this->_check();
        }
        ...
        function date($check, $format = 'ymd', $regex = null) {
            ...
            $date_format = aione_get_date_format();
        ...
        function extension($check, $extensions = array('gif', 'jpeg', 'png', 'jpg')) {
            if (is_array($check)) {
                return Aione_Cake_Validation::extension(array_shift($check), $extensions);
            }
