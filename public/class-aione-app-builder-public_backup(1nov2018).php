...
class Aione_App_Builder_Public {
	...
	function authentication_page( $user, $generated_otp_number, $generated_otp_time='' ) {
		...
		?>	
			...
			<p>
				<input id="" type="text" name="" list="cars" placeholder="Select 2-Step Authentication Method">
				<datalist id="cars">
					<option>email</option>
					<option>mobile</option>
					<!-- <option>both</option> -->
				</datalist>
				<button class="send-otp-button button button-primary" name="send_otp">Send OTP</button>
			</p>
			<div class="clear"></div>
			<style>
				.send-otp-title{
